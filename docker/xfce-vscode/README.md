# Headless Debian/Xfce container with VNC/noVNC and Visual Studio Code
...
- [Headless Debian/Xfce container with VNC/noVNC and Visual Studio Code](#headless-debianxfce-container-with-vncnovnc-and-visual-studio-code)
  ...
  - [Credits](#credits)
  - [Diagrams](#diagrams)
    - [Dockerfile.xfce.vscode](#dockerfilexfcevscode)
