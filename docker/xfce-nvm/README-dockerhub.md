# Headless Debian/Xfce container with VNC/noVNC and `NVM` for `Node.js` development
...
[badge-docker-pulls]: https://img.shields.io/docker/pulls/accetto/debian-vnc-xfce-nvm-g3

[badge-docker-stars]: https://img.shields.io/docker/stars/accetto/debian-vnc-xfce-nvm-g3
